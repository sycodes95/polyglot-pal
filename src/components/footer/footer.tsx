...
export default function Footer () {
  return (
    <div className="fixed bottom-0 flex justify-center w-full h-12 bg-background">
      <div className="max-w-7xl">
        <div className="flex items-center h-full gap-1 text-primary">
          ...
          <a className="text-pink-500 hover:underline" href="https://github.com/sycodes95" target="_blank">sycodes95</a>
        </div>
      </div>
    </div>
  )
